...
@export var shadow_texture: Texture2D = preload("res://Textures/player/Spaceships-13/spaceships/g-02.png")
...
func _ready() -> void:
	...
	if level_manager:
		...
		push_warning("LevelManager does not have _on_victory_pose")
	...
	GameManager.player_stats["base_bullet_damage"] = base_bullet_damage
	GameManager.player_stats["bullet_damage"] = base_bullet_damage
...
func shoot() -> void:
	# This function can be overridden by inherited scripts for different attack patterns
